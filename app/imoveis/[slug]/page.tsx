...
import { getImageUrl } from "@/sanity/lib/image" // Verifique o caminho
import { PROPERTY_QUERY, PROPERTIES_QUERY, SITE_SETTINGS_QUERY } from "@/sanity/lib/queries" // Verifique o caminho
import { portableTextToPlainText } from "@/sanity/lib/utils" // Verifique o caminho
                ...
                <Tabs defaultValue="description" className="mb-8">
                  ...
                  <TabsContent value="location" className="mt-4 rounded-lg border p-6">
                    ...
                    {property.mapUrl ? (
                      ...
                      <div className="aspect-video overflow-hidden rounded-lg bg-slate-200"> <div className="flex h-full items-center justify-center"> <p className="text-slate-500">Mapa da localização</p> </div> </div>
                    )}
                  </TabsContent>
                </Tabs>
