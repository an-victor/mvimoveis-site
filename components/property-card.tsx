...
export function PropertyCard({ property }: PropertyCardProps) {
  return (
    <div className="group flex flex-col overflow-hidden rounded-2xl bg-white border border-slate-100 shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 h-full">
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <Link href={`/imoveis/${property.slug.current}`} className="w-full mt-auto">
          <Button variant="outline" className="w-full border-brand-primary text-brand-primary hover:bg-brand-primary hover:text-white font-semibold transition-all duration-300 rounded-xl">
            Agendar Visita
          </Button>
        </Link>
      </div>
